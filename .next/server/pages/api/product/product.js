...
module.exports = __webpack_require__("EH/f");
...
/* harmony default export */ __webpack_exports__["default"] = (async function (req, res) {
  ...
  if (req.method === "DELETE") {
    ...
    try {
      ...
      const delprod = await crudfirebase_dproduct__WEBPACK_IMPORTED_MODULE_1__["DProduct"].getInstance().deleteProduct(dtproduct);
      return res.status(200).json({
        status: "Success"
      });
    } catch (error) {
